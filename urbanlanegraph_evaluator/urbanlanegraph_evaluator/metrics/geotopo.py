...
class Evaluator():
    def __init__(self, gt_graph, pred_graph):
    ...
    def topoMetric(self, thr=8, r=4 * 50, mask=None, verbose=False):
        ...
        return geo_precision, geo_recall, topo_precision, topo_recall
